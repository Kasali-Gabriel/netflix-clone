  ...
  return (
    <div className="flex flex-col p-2 py-10 sm:p-5 xl:pl-10">
      <div className="flex w-full flex-col pt-[40px] sm:pt-[65px] xl:grid xl:grid-cols-[2fr_1fr] xl:gap-10 xl:pt-[95px]">
        <div className="flex w-full">
          {videoUrl && (
            <iframe
              ...
              allowFullScreen
              className="h-[350px] w-full sm:h-[400px] xl:h-[550px]"
            />
          )}
        </div>
        ...
        <div className="mt-5 flex flex-col items-center space-y-5 xl:hidden">
      ...
      <div className="mt-20 hidden space-y-5 xl:-ml-7 xl:flex xl:flex-col xl:items-center">
        {recommendations.length > 0 && (
